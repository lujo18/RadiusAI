      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-6 px-4 sm:space-y-8 sm:px-6">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <button
              onClick={() => openPortal && openPortal()}
              className="mx-0 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-background shadow-lg transition-all duration-200 hover:shadow-xl"
            >
              Manage subscription
            </button>
          </div>

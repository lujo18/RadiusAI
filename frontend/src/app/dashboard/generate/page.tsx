  ...
  return (
    <div className="h-full p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">Select a template and profile to generate a new post</p>
        ...
        <div className="bg-[#1a1a1a] rounded-lg border border-gray-800 p-6 space-y-6">
          ...
          <div>
            ...
            {selectedProfile && profiles && (
              <div className="mt-2 text-sm text-gray-400">
                Niche: {profiles.find(p => p.id === selectedProfile)?.brandSettings.niche}
              </div>
            )}
          </div>
          ...
          <button
            ...
            disabled={!selectedTemplate || !selectedProfile || createPost.isPending || generating}
          ...
          >
            {createPost.isPending || generating ? 'Generating...' : 'Generate Post'}
          </button>
        </div>

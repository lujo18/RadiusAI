          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Your subscription is now active. Welcome to ViralStack!</p>
              </div>
            </div>
            <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="glass-card p-6 space-y-6">
            ...
            <div className="flex gap-2 p-1 bg-dark-300 rounded-button">
              <button className="flex-1 py-2 text-sm text-gray-400 hover:text-white transition">24h</button>
              <button className="flex-1 py-2 text-sm text-gray-400 hover:text-white transition">Week</button>
              <button className="flex-1 py-2 text-sm bg-dark-100 text-white rounded-button">Month</button>
            </div>
            ...
            <div className="relative h-48">
              ...
              <div className="absolute top-4 right-4 text-right">
                <div className="text-xs text-gray-400 mb-1">Mar 29</div>
                <div className="text-xl font-bold text-white">$ 5,638.65</div>
            ...
            <div className="pt-4 border-t border-white/5">
              ...
              <div className="text-xs text-gray-500 mt-1">Last updated: Today, 06:49 AM</div>
            </div>
          </div>
        </div>
          ...
          <div className="glass-card p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-xs text-gray-500">The sum of all amounts on my wallet</p>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-4 text-sm">
                <span className="text-gray-400">Yearly avg: $ {mockStats.monthlyRevenue.toLocaleString()}</span>
                <span className="metric-positive">

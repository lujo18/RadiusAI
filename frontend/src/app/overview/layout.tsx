...
export default function OverviewLayout({
  ...
  useEffect(() => {
    console.log("[Overview] Auth check:", {
      isLoading,
      isAuthenticated,
      hasUser: !!user,
      userId: user?.id,
  ...
  useEffect(() => {
    if (!isLoading && isAuthenticated && user) {
      ...
      console.log("[Overview] User authenticated, plan:", user?.plan || "none");
  ...
  if (isLoading || (isAuthenticated && !subscriptionChecked)) {
    console.log("[Overview] Showing loading screen");
    return (
  ...
  if (!isAuthenticated || !subscriptionChecked) {
    console.log("[Overview] Not rendering - returning null");
    return null;
  }

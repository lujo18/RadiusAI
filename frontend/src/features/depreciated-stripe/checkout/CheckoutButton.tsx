// DELETE: Depreciated — Replaced by `features/billing/checkout/CheckoutButton.tsx` and `features/billing/checkout/service.ts`.
...
const CheckoutButton = ({ planId, status }: CheckoutButtonType) => {
  ...
  const openCheckout = async () => {
    ...
    await startCheckout(planId, window.location.href);
  };

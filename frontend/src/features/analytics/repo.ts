...
type PostAnalyticsHistoryRow =
  Database["public"]["Tables"]["post_analytics_history"]["Row"];
type PostRow = Database["public"]["Tables"]["posts"]["Row"];

export class AnalyticsRepository {
  static async getPostAnalyticsHistory(
    ...
    console.log(
      "[Analytics] Calling get_processed_analytics with params:",
      params,
    );
    ...
    console.log("[Analytics] RPC response:", data, "params", params);
    return data || [];
  }

  static async getBrandAnalyticsHistory(
    timeframe: AnalyticTimeframes,
    section: AnalyticSections,
    brandId: string,
  ) {
    ...
    console.log(
      "[Analytics] Calling get_processed_analytics for brand with params:",
      params,
    );
    ...
    console.log("Decoded:", session?.user);

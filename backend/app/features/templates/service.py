...
async def create_template(
    db: AsyncSession, user_id: str, brand_id: str, payload: TemplateCreate
) -> Template:
    """
...
async def get_template(
    db: AsyncSession, template_id: str, user_id: str | None = None
) -> Template:
    """
...
async def list_user_templates(db: AsyncSession, user_id: str) -> list[Template]:
    """
...
async def list_favorite_templates(db: AsyncSession, user_id: str) -> list[Template]:
...
async def toggle_favorite(
    db: AsyncSession, template_id: str, is_favorite: bool, user_id: str | None = None
) -> Template:
...
async def search_by_category(
    db: AsyncSession, category: str, user_id: str
) -> list[Template]:
...
async def search_by_tags(
    db: AsyncSession, tags: list[str], user_id: str
) -> list[Template]:
...
async def get_default_templates(db: AsyncSession) -> list[Template]:

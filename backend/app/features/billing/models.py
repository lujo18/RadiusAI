...
from sqlalchemy import String, Integer, DateTime, JSON, ForeignKey, Index, Boolean, Enum as SQLEnum
...
class Subscription(Base):
    ...
    plan_id: Mapped[str] = mapped_column(String(50), ForeignKey("billing_plans.id"), nullable=False)
...
class Invoice(Base):
    ...
    payment_status: Mapped[str] = mapped_column(String(50))  # paid, draft, pending, void, uncollectible

...
from app.core.exceptions import NotFoundError, PermissionError as PermError, ValidationError
...
async def create_post(
    ...
    post = Post(
        ...
        content=payload.content.model_dump() if hasattr(payload.content, 'model_dump') else payload.content,

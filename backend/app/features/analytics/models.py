...
class PostAnalytic(Base):
    ...
    post_id: Mapped[str] = mapped_column(String(255), ForeignKey("posts.id"), nullable=False, index=True)
...
class PostPerformanceSummary(Base):
    ...
    id: Mapped[str] = mapped_column(String(50), primary_key=True)
    post_id: Mapped[str] = mapped_column(String(255), ForeignKey("posts.id"), nullable=False, unique=True)
    team_id: Mapped[str] = mapped_column(String(255), nullable=False, index=True)

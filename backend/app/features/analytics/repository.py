...
class AnalyticsRepository(BaseRepository[PostAnalytic]):
    ...
    async def get_by_platform(
        ...
        stmt = (
            ...
            .where(
                and_(
                    PostAnalytic.team_id == team_id,
                    PostAnalytic.platform == platform
                )
            )
            .order_by(desc(PostAnalytic.recorded_at))
            .limit(limit)
...
class PerformanceSummaryRepository(BaseRepository[PostPerformanceSummary]):
    ...
    def __init__(self):
        super().__init__(PostPerformanceSummary)
    ...
    async def get_or_create(
        ...
        return await self.create(db, summary)
    ...
    async def update_summary(
        ...
        if summary:
            ...
            return await self.update(db, summary)
